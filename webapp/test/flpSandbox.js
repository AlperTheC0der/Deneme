		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Project",
									"targetURL": "#comnttsmuserproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttsmuserproject1-display": {
								"semanticObject": "comnttsmuserproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.sm.userproject1",
									"url": sap.ui.require.toUrl("com/ntt/sm/userproject1")
								}
							}
						}
					}
